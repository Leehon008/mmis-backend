...
namespace MMIS.API.Controllers
{
    ...
    public class OperatorController : ControllerBase
    {
        ...
        public OperatorController(UserManager<ApplicationUser> userManager, IMapper mapper, RoleManager<ApplicationRole> roleManager, MMISDbContext context)
        {
        ...
        public async Task<IActionResult> GetOperators(string Id, string moduleId)
        {
            ...
            {
                if (user.Designation.Equals("TeamLeader"))
                {
                    user.Designation = "Operator";
                }
                if (user.Designation.Equals("Operator") && user.PlantId.Equals(Id) && user.Usergroup.Equals(moduleId))
                {
