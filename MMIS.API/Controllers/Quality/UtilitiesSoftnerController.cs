...
namespace MMIS.API.Controllers.Quality
{
    ...
    public class UtilitiesSoftnerController : ControllerBase
    {
        ...
        public UtilitiesSoftnerController(MMISDbContext context, IFileUploadLogic fileUploadLogic, IMapper mapper)
        {
            _context = context;
        ...
        //{
        //    return await _context.QualityUtilitiesSoftner.ToListAsync();
        //}
        ...
        {
            return await _context.QualityUtilitiesSoftner.Where(m => m.Plant.Contains(Plant) && m.Name.ToLower().Contains("softener")).OrderByDescending(m => m.Id).ToListAsync();        }

        // GET: api/Vessel/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Vessel>> GetVessel(int id)
        {
            var utilities = await _context.QualityUtilitiesSoftner.FindAsync(id);
        ...
        public async Task<IActionResult> PutVessel(int id, Vessel utilities)
        {
            ...
            utilities.Id = id;
            utilities.Created = _context.QualityUtilitiesSoftner.Where(m => m.Id == id).Select(m => m.Created).FirstOrDefault();
        ...
        public async Task<ActionResult<Vessel>> PostVessel(Vessel utilities)
        {
            ...
            _context.QualityUtilitiesSoftner.Add(utilities);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<Vessel>> DeleteVessel(int id)
        {
            ...
            _context.QualityUtilitiesSoftner.Remove(utilities);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.QualityUtilitiesSoftner.Any(e => e.Id == id);
        }
    }
}
